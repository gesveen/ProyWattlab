            ...
            <div className="container" style={{ marginTop: '20px', marginBottom: "20px", textAlign: "center"}}>
                <div className="row">
                    <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div className="card" style={{width: "18rem"}}>
                            <div style={{textAlign: "center", marginTop: "20px"}}>
                                <svg class="bi bi-house-fill" width="80px" height="80px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div className="card" style={{width: "18rem"}}>
                            <div style={{textAlign: "center", marginTop: "20px"}}>
                                <svg class="bi bi-person-lines-fill" width="80px" height="80px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div className="card" style={{width: "18rem"}}>
                            <div style={{textAlign: "center", marginTop: "20px"}}>
                                <svg class="bi bi-tools" width="80px" height="80px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
