                    ...
                    <div className="col-lg-5" style={{ marginTop: "20px" }}>
                        ...
                        <form onSubmit={(event) => handleFormSubmit(event)} > 
                            ...
                            <div className="form-group">
                                <input name="asunto" className="form-control" placeholder="Asunto" ></input>
                            </div>
                            <div className="form-group">
                                <input name="email" className="form-control" type="email" placeholder="Correo electrónico"></input>
                            </div>
                            <div>
                                <input name="contenido" className="form-control" placeholder="Descripción" style={{ height: "200px", verticalAlign: "top" }}></input>
                            </div>
                            <div style={{ marginTop: "20px" }}>
                                <button type="primary"  htmlType="submit" className="btn btn-success btn-block">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
